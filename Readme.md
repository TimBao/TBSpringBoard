...
------------
 ...
 There are 2 ways to use SpringBoard in your project:
 - using CocoaPods: pod 'TBSpringBoard', '~> 0.0.1'
 - Copying all files in SpringBoard to your project and implemente the delegate.
